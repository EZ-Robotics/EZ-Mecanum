...
inline pros::Motor r1_back(15, true);
inline pros::Motor r2_back(9);
inline pros::Motor r1_front(16, true);
inline pros::Motor r2_front(17);
inline pros::Motor l1_back(10);
inline pros::Motor l2_back(20, true);
 ...
 * Controls
 */
#define B_INDEXER_TRIPPLE pros::E_CONTROLLER_DIGITAL_R2
#define B_INDEXER_SPAM pros::E_CONTROLLER_DIGITAL_R1
#define B_INTAKE_IN pros::E_CONTROLLER_DIGITAL_L1
#define B_INTAKE_OUT pros::E_CONTROLLER_DIGITAL_L2
#define B_FLYWHEEL_MAX pros::E_CONTROLLER_DIGITAL_DOWN
#define B_FLYWHEEL_SLOW pros::E_CONTROLLER_DIGITAL_B
